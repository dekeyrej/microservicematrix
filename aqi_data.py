...
pollutant_measures = {
    "o3":    {"name": "Ozone", "units": "ppm",   "decimals": 3}, 
    "pm2_5": {"name": "Particulate Matter (2.5 microns)", "units": "ug/m3", "decimals": 1}, 
    "pm10":  {"name": "Particulate Matter (10 microns)", "units": "ug/m3", "decimals": 0}, 
    "co":    {"name": "Carbon Monoxide", "units": "ppm",   "decimals": 1}, 
    "so2":   {"name": "Sulfur Dioxide", "units": "ppb",   "decimals": 0}, 
    "no2":   {"name": "Nitrogen Dioxide", "units": "ppb",   "decimals": 0}
}
...
aqidata = {
    ...
    "o3_low":  [0, 0.055, 0.071, 0.086, 0.106, 0.201], 
    "o3_high": [0.054, 0.07, 0.085, 0.105, 0.2, 0.5], 
